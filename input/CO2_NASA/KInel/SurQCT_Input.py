...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, SurQCTFldr):
        ...
        self.PathToRunFld        = self.SurQCTFldr + '/../' + self.RatesType + '_CO2_TransLearn/all_temperatures_nondim/' + self.ExcitType + '/' # Path To Training Fldr
        self.TBCheckpointFldr    = self.SurQCTFldr + '/../' + self.RatesType + '_CO2_TransLearn/all_temperatures_nondim/TB/'
        ...
        self.PathToHAHDF5File    = self.WORKSPACE_PATH  + '/Air_Database/HDF5_Database_Active/CO2_NASA.hdf5'
        self.PathToHDF5File      = self.WORKSPACE_PATH  + '/Air_Database/HDF5_Database/CO2_NASA.hdf5'
        self.Molecules           = ['N2','N2'] 
        self.PathToLevelsFile    = [self.WORKSPACE_PATH + '/Air_Database/Run_0D/database/levels/CO_NASA_log_nd.csv',
                                    self.WORKSPACE_PATH + '/Air_Database/Run_0D/database/levels/CO_NASA_log_nd.csv']
        self.PathToDiatFile      = [self.WORKSPACE_PATH + '/CoarseAIR/coarseair/dtb/Molecules/CO/NASA/CO_levels_venturi.dat',
                                    self.WORKSPACE_PATH + '/CoarseAIR/coarseair/dtb/Molecules/CO/NASA/CO_levels_venturi.dat']      
        ...
        self.PathToSampledLevels = self.WORKSPACE_PATH  + '/Air_Database/Run_0D/database/levels/Active_Sampled/CO_T'
        ...
        self.WeightDecay         = np.array([1.e-1, 1.e-1], dtype=np.float64)                                # Hyperparameters for L1 and L2 Weight Decay Regularizations
        self.ImpThold            = 1.e-4   
        self.NPatience           = 300 
