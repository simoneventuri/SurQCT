...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, SurQCTFldr):
        ...
        self.PathToLevelsFile    = [self.WORKSPACE_PATH + '/Air_Database/Run_0D/database/levels/N2_LeRoy_Bottom_Vib_we_nd.csv',
                                    self.WORKSPACE_PATH + '/Air_Database/Run_0D/database/levels/N2_LeRoy_Bottom_Vib_we_nd.csv']
