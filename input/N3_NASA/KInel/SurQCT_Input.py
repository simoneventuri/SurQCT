...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, SurQCTFldr):
        ...
        self.TransferModelFld    = self.WORKSPACE_PATH  + "/SurQCT/KExcit/all_temperatures_nondim/KInel/Run_15/"
        ...
        self.PathToSampledLevels = self.WORKSPACE_PATH  + '/Air_Database/Run_0D/database/levels/Active_Sampled_withLowVLowJ/N2_T'
        ...
        self.WeightDecay         = np.array([1.e-1, 1.0], dtype=np.float64)                                # Hyperparameters for L1 and L2 Weight Decay Regularizations
        self.ImpThold            = 1.e-4   
        self.NPatience           = 300 
