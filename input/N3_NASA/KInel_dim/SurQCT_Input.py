...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, SurQCTFldr):
        ...
        self.PathToRunFld        = self.SurQCTFldr + '/../' + self.RatesType + '_N3_QCTLearn/all_temperatures/' + self.ExcitType + '/' # Path To Training Fldr
        self.TBCheckpointFldr    = self.SurQCTFldr + '/../' + self.RatesType + '_N3_QCTLearn/all_temperatures/TB/'
        ...
        self.PathToLevelsFile    = [self.WORKSPACE_PATH + '/Air_Database/Run_0D/database/levels/N2_LeRoy_Bottom.csv',
                                    self.WORKSPACE_PATH + '/Air_Database/Run_0D/database/levels/N2_LeRoy_Bottom.csv']
        ...
        self.xVarsVec_i          = ['log_EVib','log_ERot','ri','log_ro','log_Tau'] 
        self.xVarsVec_Delta      = ['log_EVib','log_ERot','ri','log_ro','log_Tau'] 
