...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, SurQCTFldr):
        ...
        self.TransferModelFld    = self.WORKSPACE_PATH  + "/SurQCT/KExcit/all_temperatures_nondim/KInel/Run_53/"
        ...
        self.TTranVecTrain       = np.array([1500.0, 5000.0, 7500.0, 10000.0, 12000.0, 15000.0, 20000.0])
        ...
        #self.PathToSampledLevels = self.WORKSPACE_PATH  + '/SurQCT/surqct/scripts/PipeLine_CoarseAIR/N2_ResPts61_T'        
        ...
        self.NEpoch              = 5000          # Number of Epoches
        self.ESFlg               = True
        ...
        self.WeightDecay         = np.array([5.e-5, 1.e-5], dtype=np.float64)       # Hyperparameters for L1 and L2 Weight Decay Regularizations
        self.ImpThold            = 1.e-4   
        self.NPatience           = 300 
