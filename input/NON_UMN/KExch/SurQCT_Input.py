...
#        self.PathToGrouping      = self.WORKSPACE_PATH  + '/Air_Database/Run_0D/database/grouping/NO_UMN/NO/LevelsMap_DPM45.csv'  
        self.NbProcesses         = 4
        self.HomoExchNb          = 1
        ...
        self.TransferModelFld    = self.WORKSPACE_PATH  + "/SurQCT_MAITH/KExcit/all_temperatures_nondim/KExch/Run_6/"
