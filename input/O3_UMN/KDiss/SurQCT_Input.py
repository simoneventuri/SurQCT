...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, SurQCTFldr):
        ...
        self.PathToRunFld        = self.SurQCTFldr + '/../' + self.RatesType + '/all_temperatures/'       # Path To Training Fldr
        ...
        self.PathToLevelsFile    = [self.WORKSPACE_PATH + '/Air_Database/Run_0D/database/levels/Active_Sampled/O2_AIAA.csv',
                                    self.WORKSPACE_PATH + '/Air_Database/Run_0D/database/levels/Active_Sampled/O2_AIAA.csv']
        ...
        self.xVarsVec_i          = ['EVib','ERot','VMax','ro','rMax']#['EVib','ERot','rMin','rMax','VMin','VMax','Tau','ri','ro']
        self.xVarsVec_Delta      = []
        self.OtherVar            = ''
