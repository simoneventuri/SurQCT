...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, SurQCTFldr):
        ...
        self.PathToLevelsFile    = [self.WORKSPACE_PATH + '/Air_Database/Run_0D/database/levels/O2_UMN_Diss_log_nd.csv',
                                    self.WORKSPACE_PATH + '/Air_Database/Run_0D/database/levels/O2_UMN_Diss_log_nd.csv']
        ...
        self.xVarsVec_i          = ['EVib','ERot'] #['EVib','ERot','VMin','VMax','Tau','ri','ro','vqn','jqn']
        self.xVarsVec_Delta      = ['EVib','ERot'] #['EVib','ERot','VMin','VMax','Tau','ri','ro','vqn','jqn']
