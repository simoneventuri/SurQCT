...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, SurQCTFldr):
        ...
        self.TransferModelFld    = self.WORKSPACE_PATH  + "/SurQCT/KExcit/all_temperatures_nondim/KExch/Run_1/"
        self.xVarsVec_i          = ['EVib','ERotR','EInt','VMin','VMax','rMin','rMax','ri','ro','Tau'] #['EVib','ERot','VMin','VMax','Tau','ri','ro','vqn','jqn']
        self.xVarsVec_Delta      = ['EVib','ERotR','EInt','VMin','VMax','rMin','rMax','ri','ro','Tau'] #['EVib','ERot','VMin','VMax','Tau','ri','ro','vqn','jqn']
