...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, SurQCTFldr):
        ...
        self.PathToRunFld        = self.SurQCTFldr + '/../' + self.RatesType + '/' + self.ExcitType + '_Test' + str(self.NNRunIdx) # Path To Training Folder
        ...
        self.ApproxModel         = 'ResDotNet'
        self.NNLayers            = [np.array([64, 64, 64, 64, 64]), np.array([64, 64, 64, 64, 64])]
        self.ActFun              = [['relu', 'relu', 'relu', 'relu', 'relu'], ['relu', 'relu', 'relu', 'relu', 'relu']]
        ...
        #=======================================================================================================================================
        ### Training Quanties
        self.xVarsVec            = ['EVib','ERot','ri','ro'] #['EVib','ERot','VMin','VMax','Tau','ri','ro','vqn','jqn']
        self.OtherVar            = '_Delta'
        self.NSamplesNoise       = 0
        self.RandDataFlg         = True                                                                      # Randomize Training Data 

        self.TTranVecTrain       = np.array([1500.0])#, 2500.0, 5000.0, 10000.0, 15000.0, 20000.0, 30000.0, 50000.0])#np.array([1500.0, 5000.0, 8000.0, 12000.0, 15000.0, 20000.0])
