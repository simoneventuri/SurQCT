...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, SurQCTFldr):
        ...
        self.PathToRunFld        = self.SurQCTFldr + '/../' + self.RatesType + '/all_temperatures/' + self.ExcitType + '_FNN/' # Path To Training Fldr
        self.TBCheckpointFldr    = self.SurQCTFldr + '/../' + self.RatesType + '/all_temperatures/TB_FNN/'
        ...
        self.NNLayers            = np.array([64, 64, 64, 64])
        self.ActFun              = ['tanh', 'tanh', 'tanh', 'tanh']
        ...
        self.xVarsVec_Delta      = ['EVib','ERot','rMin','rMax','VMin','VMax','Tau','ri','ro'] #['EVib','ERot','VMin','VMax','Tau','ri','ro','vqn','jqn']
