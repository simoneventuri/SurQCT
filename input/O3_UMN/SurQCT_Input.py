...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, SurQCTFldr):
        ...
        self.NNLayers            = np.array([32, 32])
        self.ActFun              = ['sigmoid', 'sigmoid']

        ################################################################################################################################################################
        ### Training Quanties
        self.xVarsVec            = ['EVib','ERot','rMin','rMax','VMin','VMax','Tau','ri','ro']
        self.TTranVecTrain       = np.array([1500.0, 5000.0, 8000.0, 12000.0, 15000.0, 20000.0])
        ...
        self.LearningRate        = 5.e-5                                                                     # Initial Learning Rate
        ...
        self.ImpThold            = 1.e-4
        self.NPatience           = 500
        self.ValidPerc           = 40.0                                                                      # Percentage of Training Data to Be Used for Validation (e.g., = 20.0 => 20%)

        ################################################################################################################################################################
        ### Testing Quantities
        self.TestPerc            = 95.0                                                                      # Percentage of Overall Data to Be Used for Testing (e.g., = 20.0 => 20%)
...
#        self.OptimizerParams     = [0.9, 0.999, 1e-07]  # ADAM
