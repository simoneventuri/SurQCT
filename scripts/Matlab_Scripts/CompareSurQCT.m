...
Input.Paths.ToKinMainFldr1       = strcat(Input.WORKSPACE_PATH, '/Air_Database/Run_0D_surQCT/TestI_23_TestD_0');
Input.Paths.ToHDF5Fldr          = strcat(Input.WORKSPACE_PATH, '/Air_Database/HDF5_Database/');
Input.TranVec                   = [2500, 5000, 6000, 8000, 10000, 12000, 14000, 15000, 20000];
...
Input.Kin.DissCorrFactor        = 1;%16.0/3.0;
...
Input.Paths.SaveDataFldr = strcat(Input.WORKSPACE_PATH, '/SurQCT/AviationPaper/Data/QCT/');
