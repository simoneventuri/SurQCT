...
%
function Plot_MoleFracs_and_GlobalRates(Controls, Kin, Rates)    
    ...
    global Input Param Syst OtherSyst Temp 
    ...
    for iComp = Controls.CompStart:Controls.CompEnd
        ...
        semilogx(Kin.T(Temp.iT).t(:), Kin.T(Temp.iT).MolFracs(:,iComp), 'Color',[0,1,0], 'linestyle', Syst.CFDComp(iComp).LineStyle, 'LineWidth', Param.LineWidth)
        hold on
