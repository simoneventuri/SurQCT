...
%
function Plot_Populations(Controls, Kin, Rates)    
    ...
    for iMol = Controls.MoleculesOI
        ...
        for tStep = Controls.tSteps
            ...
            if Controls.GroupColors == 0
                ...
                %scatter(LevelEeV, LevelPop, 300, '.', 'MarkerEdgeColor', Syst.CFDComp(iComp).Color, 'MarkerFaceColor', Syst.CFDComp(iComp).Color, 'LineWidth', 1.5)
                scatter(LevelEeV, LevelPop, 300, '.', 'MarkerEdgeColor', 'r', 'MarkerFaceColor', 'r', 'LineWidth', 1.5)
                hold on
                box on
                ylim([1.d5, 1.d23]);
