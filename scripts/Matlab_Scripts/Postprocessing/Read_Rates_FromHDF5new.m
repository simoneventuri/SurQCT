...
%
%  Input Global Var: - Temp.TNownewChar
%                    - Syst.HDF5_File
%
function [Rates] = Read_Rates_FromHDF5new(Rates, Syst, OtherSyst, iSyst)    
    ...
    Temp.TNownew = 10000;
     Temp.TNownewChar = num2str(Temp.TNownew)
    ...
    if (Syst.NAtoms == 3)
        ...
        if (Input.Kin.ReadRatesProc(iSyst, 1) == 1)
            DissChar       = strcat('/T_', Temp.TNownewChar, '_', Temp.TNownewChar, '/Rates/Diss/');
        ...
        elseif (Input.Kin.ReadRatesProc(iSyst, 1) == 2)
            ...
            RecombChar = strcat('/T_', Temp.TNownewChar, '_', Temp.TNownewChar, '/RatesMicroRev/Recomb/');
            %h5disp(Syst.HDF5_File, DissChar)
        ...
        elseif (Input.Kin.ReadRatesProc(iSyst, 1) == 3)
            DissChar       = strcat('/T_', Temp.TNownewChar, '_', Temp.TNownewChar, '/Rates', Input.RunSuffix, '/Diss/');
            DissChar
            %h5disp(Syst.HDF5_File, DissChar)
            RatesTemp                 = h5read(Syst.HDF5_File, DissChar);
            Rates.T(Temp.iT).Diss     = permute(RatesTemp, [2,1]);
        ...
        if (Input.Kin.ReadRatesProc(iSyst, 2) == 1)
            InelChar       = strcat('/T_', Temp.TNownewChar, '_', Temp.TNownewChar, '/Rates/Inel/');
        ...
        elseif (Input.Kin.ReadRatesProc(iSyst, 2) == 2)
            InelChar       = strcat('/T_', Temp.TNownewChar, '_', Temp.TNownewChar, '/RatesMicroRev/Inel/');
            %h5disp(Syst.HDF5_File, InelChar)
            RatesTemp             = h5read(Syst.HDF5_File, InelChar);
            Rates.T(Temp.iT).Inel = permute(RatesTemp, [2,1]);
        ...
        elseif (Input.Kin.ReadRatesProc(iSyst, 2) == 3)
            InelChar       = strcat('/T_', Temp.TNownewChar, '_', Temp.TNownewChar, '/Rates', Input.RunSuffix, '/Inel/');
            %h5disp(Syst.HDF5_File, InelChar)
            RatesTemp             = h5read(Syst.HDF5_File, InelChar);
            Rates.T(Temp.iT).Inel = permute(RatesTemp, [2,1]);
...
%                 ExchChar  = strcat('/T_', Temp.TNownewChar, '_', Temp.TNownewChar, '/Rates/Exch_', num2str(iExch), '/');
...
%                 ExchChar  = strcat('/T_', Temp.TNownewChar, '_', Temp.TNownewChar, '/RatesMicroRev/Exch_', num2str(iExch), '/');
%                 RatesTemp = h5read(Syst.HDF5_File, ExchChar);
%                 Rates.T(Temp.iT).ExchType(iExch).Exch = permute(RatesTemp, [2,1]);
...
%                 ExchChar  = strcat('/T_', Temp.TNownewChar, '_', Temp.TNownewChar, '/Rates', Input.RunSuffix, '/Exch_', num2str(iExch), '/');
%                 RatesTemp = h5read(Syst.HDF5_File, ExchChar);
%                 Rates.T(Temp.iT).ExchType(iExch).Exch = permute(RatesTemp, [2,1]);
...
%         end
        ...
        DissCharInel   = strcat('/T_', Temp.TNownewChar, '_', Temp.TNownewChar, '/Rates/DissInel/');
