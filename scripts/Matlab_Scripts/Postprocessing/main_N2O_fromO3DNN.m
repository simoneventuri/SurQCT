...
Input.Kin.EqNStatesIn           = [  9093,    6739];
Input.Kin.MinStateIn            = [      1,      1];
Input.Kin.MaxStateIn            = [  9093,    6739];
...
Input.Kin.NGroupsOut            = [  9093,    6739];
...
Input.Tasks.Plot_Populations.tSteps                    = [5e-8]; %[1.e-13, 1e-12, 1.e-11, 1e-10, 1e-9, 1e-8]%[8.94e-7]%[7.e-6, 30e-6, 100e-6, 5.e-3];
...
Input.KinDNN.Proc.OverallFlg = strcat(num2str(Input.Kin.Proc.DissFlg),'_',num2str(Input.Kin.Proc.DNNInelFlg),'_',num2str(Input.Kin.Proc.ExchFlg1),'_',num2str(Input.Kin.Proc.ExchFlg2));
