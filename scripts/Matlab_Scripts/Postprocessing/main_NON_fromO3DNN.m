...
Input.Paths.ToKinMainFldrQCT    = strcat(Input.WORKSPACE_PATH, '/Air_Database/Run_0D_surQCT/FromSungMin/');
Input.Paths.ToKinMainFldrQCT1   = strcat(Input.WORKSPACE_PATH, '/Air_Database/Run_0D/');
...
Input.Kin.EqNStatesIn           = [  6739,    9093];
...
Input.Kin.Proc.ExchFlg2         = 1;
Input.Kin.Proc.DNNExchFlg2      = 1;
...
Input.KinDNN.Proc.OverallFlg = strcat(num2str(Input.Kin.Proc.InelDissFlg),'_',num2str(Input.Kin.Proc.DNNInelFlg),'_',num2str(Input.Kin.Proc.DNNExchFlg1),'_',num2str(Input.Kin.Proc.DNNExchFlg2));
...
for iT = 1:length(Temp.TranVec)
    ...
    PathToKinRunFldrQCT = strcat(Input.Paths.ToKinMainFldrQCT1,'/output_', Syst.NameLong, Input.RunSuffix, '_T', Temp.TNowChar, 'K_', Input.Kin.Proc.OverallFlg);
