...
Input.TranVec                   = [5000]%[2500 5000 7500 10000 12500 15000 20000];%[5000 10000 20000] [12500 15000 20000]% 
...
Input.Kin.EqNStatesIn           = [   6078,   13521];
...
Input.Kin.NGroupsOut            = [   6078,   13521]; % 49, 83
...
Input.Paths.SaveFigsFldr = strcat(Input.WORKSPACE_PATH, '/SurQCT/O2C/');
...
Input.Tasks.Plot_Populations.ColorIdx                  = 4;
...
Input.Tasks.Plot_EnergyDepletions.Proj                 = [2,2];
Input.Tasks.Plot_EnergyDepletions.Targ                 = [  4];
...
%            RatesFldrD = strcat(Input.Paths.ToKinMainFldrQCT, '/database/kinetics/',Syst.NameLong,'/T', Temp.TNowChar, 'K/');
            ...
            RateSourceDNN = Input.Kin.RateSourceQCT;
