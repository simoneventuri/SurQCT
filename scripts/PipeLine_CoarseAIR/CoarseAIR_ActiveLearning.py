...
if __name__ == "__main__": 
    ...
    #plt.style.use(SurQCTFldr+'/scripts/postprocessing/presentation.mplstyle')
    plt.style.use(SurQCTFldr+'/scripts/postprocessing/paper.mplstyle')
    ...
    CoarseAIRFile  = SurQCTFldr     + '/scripts/PipeLine_CoarseAIR/CoarseAIR_Templates/CoarseAIR.sh'
    DtbPath        = WORKSPACE_PATH + '/CoarseAIR/coarseair/dtb/'        

    ### System-Specific Input
    InputFrmtFile  = SurQCTFldr     + '/scripts/PipeLine_CoarseAIR/CoarseAIR_Templates/O3_UMN/input/CoarseAIR.inp'                         
    System         = 'O3'
    Molecule       = 'O2'
    ...
    ### Run-Specific Input
    RunFldr        = WORKSPACE_PATH + '/SurQCT/ActiveCoarseAIR_O3_UMN/'                                 
    NProc          = 20
    TVec           = np.array([10000.0])                                                                    
    NSamples       = 45
    ### NOTE: Do not forget to change quantities (e.g., no of trajectories) from /SurQCT/surqct/scripts/PipeLine_CoarseAIR/CoarseAIR_Templates/O3_UMN/input/CoarseAIR.inp!
    ...
    for T in TVec:
        ...
        try:
            ...
            pass
        RunFldrT       = WORKSPACE_PATH + '/SurQCT/Test_CoarseAIR/Test_T' + str(int(T)) + 'K/'
        try:
